...
"[project]/app/api/admin/artists/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getHandler(request) {
    try {
        const artists = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAll"])('SELECT * FROM artists ORDER BY created_at DESC');
...
async function postHandler(request) {
    try {
        ...
        const artist = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["insert"])(`INSERT INTO artists (name, slug, bio, image_url)
       VALUES ($1, $2, $3, $4)
       RETURNING *`, [
            name,
            slug,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3cbec90e._.js.map