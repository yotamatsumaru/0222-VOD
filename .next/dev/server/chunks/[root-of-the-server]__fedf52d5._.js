...
async function getHandler(request) {
    try {
        const events = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAll"])(`SELECT e.*, a.name as artist_name
       FROM events e
...
async function postHandler(request) {
    try {
        ...
        const { artistId, title, slug, description, thumbnailUrl, streamUrl, archiveUrl, status, startTime, endTime } = body;
        ...
        const event = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["insert"])(`INSERT INTO events (
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fedf52d5._.js.map