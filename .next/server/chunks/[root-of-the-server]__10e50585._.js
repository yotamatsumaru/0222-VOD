module.exports=[23862,e=>e.a(async(r,t)=>{try{let r=await e.y("pg-587764f78a6c7a9c");e.n(r),t()}catch(e){t(e)}},!0),93695,(e,r,t)=>{r.exports=e.x("next/dist/shared/lib/no-fallback-error.external.js",()=>require("next/dist/shared/lib/no-fallback-error.external.js"))},70406,(e,r,t)=>{r.exports=e.x("next/dist/compiled/@opentelemetry/api",()=>require("next/dist/compiled/@opentelemetry/api"))},18622,(e,r,t)=>{r.exports=e.x("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js",()=>require("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js"))},56704,(e,r,t)=>{r.exports=e.x("next/dist/server/app-render/work-async-storage.external.js",()=>require("next/dist/server/app-render/work-async-storage.external.js"))},32319,(e,r,t)=>{r.exports=e.x("next/dist/server/app-render/work-unit-async-storage.external.js",()=>require("next/dist/server/app-render/work-unit-async-storage.external.js"))},24725,(e,r,t)=>{r.exports=e.x("next/dist/server/app-render/after-task-async-storage.external.js",()=>require("next/dist/server/app-render/after-task-async-storage.external.js"))},62294,e=>e.a(async(r,t)=>{try{var n=e.i(23862),o=r([n]);[n]=o.then?(await o)():o;let p=null;async function a(e,r){let t=function(){if(!p){let e=process.env.DATABASE_URL;if(!e)throw console.error("DATABASE_URL is not defined in environment variables"),Error("DATABASE_URL is not configured");console.log("Initializing database connection pool..."),console.log("Database URL format:",e.replace(/:[^:@]+@/,":****@")),(p=new n.Pool({connectionString:e,ssl:{rejectUnauthorized:!1},max:20,idleTimeoutMillis:3e4,connectionTimeoutMillis:5e3})).on("error",e=>{console.error("Unexpected error on idle client",e)}),p.on("connect",()=>{console.log("Database connection established")})}return p}();try{let n=Date.now(),o=await t.query(e,r),a=Date.now()-n;return console.log("Query executed:",{sql:e.substring(0,100),duration:`${a}ms`,rows:o.rowCount}),o}catch(t){throw console.error("Database query error:",{sql:e.substring(0,200),params:r,error:t.message,code:t.code,detail:t.detail}),t}}async function i(e,r){return(await a(e,r)).rows[0]||null}async function s(e,r){return(await a(e,r)).rows}async function l(e,r){return(await a(e,r)).rows[0]}async function d(e,r){return(await a(e,r)).rows[0]||null}async function c(e,r){let t=await a(e,r);return null!==t.rowCount&&t.rowCount>0}e.s(["getAll",()=>s,"getOne",()=>i,"insert",()=>l,"query",()=>a,"remove",()=>c,"update",()=>d]),t()}catch(e){t(e)}},!1),24361,(e,r,t)=>{r.exports=e.x("util",()=>require("util"))},54799,(e,r,t)=>{r.exports=e.x("crypto",()=>require("crypto"))},874,(e,r,t)=>{r.exports=e.x("buffer",()=>require("buffer"))},88947,(e,r,t)=>{r.exports=e.x("stream",()=>require("stream"))},133,e=>{"use strict";var r=e.i(24652);let t=process.env.JWT_SECRET||"fallback_secret_key";function n(e,n){return r.default.sign({userId:e,email:n,type:"password_reset"},t,{expiresIn:"1h"})}function o(e){try{let n=r.default.verify(e,t);if("password_reset"!==n.type)return null;return{userId:n.userId,email:n.email}}catch{return null}}function a(e,r){return`
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
//# sourceMappingURL=%5Broot-of-the-server%5D__10e50585._.js.map